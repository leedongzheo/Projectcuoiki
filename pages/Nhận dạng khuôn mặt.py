...
add_bg_from_local('Background/NhanDangKhuonMat.jpg') 

# st.set_page_config(page_title="Nhận dạng khuôn mặt")
...
mydict = ['BanKiet', 'BanNghia', 'BanThanh', 'Nguyen Tran Anh Thu_21146157','SangSang', 'ThayDuc']
...
if __name__ == '__main__':
    detector = cv.FaceDetectorYN.create(
        'ModelNhanDangKhuonMat/face_detection_yunet_2022mar.onnx',
        "",
        (320, 320),
        0.9,
        0.3,
